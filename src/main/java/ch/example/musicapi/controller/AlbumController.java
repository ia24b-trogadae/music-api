...
public class AlbumController {
    ...
    @Operation(summary = "Get album by id", description = "Returns one album by its id including songs")
    @ApiResponses({
    ...
    @Operation(summary = "Get albums by release date", description = "Returns all albums with the given release date")
    ...
    @Operation(summary = "Create a new album", description = "Creates a new album including its songs")
    @ApiResponses({
