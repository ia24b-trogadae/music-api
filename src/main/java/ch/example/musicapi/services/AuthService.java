...
public class AuthService {
    ...
    public AuthService(AppUserDao appUserDao, PasswordEncoder passwordEncoder, JwtService jwtService) {
    ...
    public LoginResponse login(LoginRequest request) {
        AppUser user = appUserDao.findByUsername(request.getUsername())
