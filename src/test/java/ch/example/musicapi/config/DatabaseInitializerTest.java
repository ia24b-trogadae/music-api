...
class DatabaseInitializerTest {
    ...
    void startupScript_whenDatabaseAlreadyInitialized_doesNotDuplicateData() throws Exception {
        Integer albumCountBefore =
                jdbcTemplate.queryForObject("SELECT COUNT(*) FROM album", Integer.class);
        Integer songCountBefore =
                jdbcTemplate.queryForObject("SELECT COUNT(*) FROM song", Integer.class);
        Integer roleCountBefore =
                jdbcTemplate.queryForObject("SELECT COUNT(*) FROM role", Integer.class);
        Integer userCountBefore =
                jdbcTemplate.queryForObject("SELECT COUNT(*) FROM app_user", Integer.class);

        databaseInitializer.run();

        Integer albumCountAfter =
                jdbcTemplate.queryForObject("SELECT COUNT(*) FROM album", Integer.class);
        Integer songCountAfter =
                jdbcTemplate.queryForObject("SELECT COUNT(*) FROM song", Integer.class);
